document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value.trim() !== '' && type === 'email' && !VALIDATORS.email(value)) {
        showError(field, customMessage || field.getAttribute('data-email-message') || 'Please enter a valid email address.');
        return false;
      }

      if (value.trim() !== '' && type === 'tel' && !VALIDATORS.tel(value)) {
        showError(field, customMessage || field.getAttribute('data-tel-message') || 'Please enter a valid phone number.');
        return false;
      }

      if (value.trim() !== '' && minlength && !VALIDATORS.minlength(value, minlength)) {
        showError(field, customMessage || field.getAttribute('data-minlength-message') || 'Please enter at least ' + minlength + ' characters.');
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd480c00b-2b82-4820-b455-296e01448d20',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd480c00b-2b82-4820-b455-296e01448d20';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd480c00b-2b82-4820-b455-296e01448d20';
